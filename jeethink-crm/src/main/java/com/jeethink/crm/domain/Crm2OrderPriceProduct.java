 ...
 * @date 2020-04-03
 */
public class Crm2OrderPriceProduct extends BaseEntity
{
    ...
    private CrmOrderPrice orderPrice;
	...
	public CrmOrderPrice getOrderPrice() {
		return orderPrice;
	}

	public void setOrderPrice(CrmOrderPrice orderPrice) {
