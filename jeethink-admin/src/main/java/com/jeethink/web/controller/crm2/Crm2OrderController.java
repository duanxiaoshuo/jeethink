 ...
 */
@Controller
@RequestMapping("/crm2/order")
public class Crm2OrderController extends BaseController
{
    private String prefix = "crm2/order";

    @Autowired
    private ICrm2OrderService crmOrderService;
