 ...
 */
@Controller
@RequestMapping("/crm2/contractPayment")
public class Crm2ContractPaymentController extends BaseController
{
    private String prefix = "crm2/contractPayment";

    @Autowired
    private ICrm2ContractPaymentService crmContractPaymentService;
