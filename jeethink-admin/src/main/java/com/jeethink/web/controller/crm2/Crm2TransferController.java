...
import com.jeethink.crm.service.crm2.ICrm2TransferService;
 ...
 */
@Controller
@RequestMapping("/crm2/transfer")
public class Crm2TransferController extends BaseController
{
    private String prefix = "crm2/transfer";

    @Autowired
    private ICrm2TransferService crmTransferService;
