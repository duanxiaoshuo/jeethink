 ...
 */
@Controller
@RequestMapping("/crm2/contract")
public class Crm2ContractController extends BaseController
{
    private String prefix = "crm2/contract";
    
    @Autowired
    private ICrm2CustomerService crmCustomerService;

    @Autowired
    private ICrm2ContractService crmContractService;
